...
namespace CalibreData
{
	class UsingConfigurationCollectionAttribute
	{
		...
		// http://msdn.microsoft.com/en-us/library/system.configuration.configurationcollectionattribute(v=vs.110).aspx
		...
		static void ReadCustomSection()
		{
			try {
				...
				UrlsSection myUrlsSection = ConfigurationManager.GetSection("MyUrls") as UrlsSection;
