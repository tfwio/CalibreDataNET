...
WHERE [id] = @xid;";
		...
		{
			Books_authors_link model = new Books_authors_link();
			if (row["id"]!=DBNull.Value) model.id = row["id"] as long?;
			if (row["book"]!=DBNull.Value) model.book = row["book"] as long?;
...
WHERE [id] = @xid;";
		...
		{
			Books_publishers_link model = new Books_publishers_link();
			if (row["id"]!=DBNull.Value) model.id = row["id"] as long?;
			if (row["book"]!=DBNull.Value) model.book = row["book"] as long?;
...
WHERE [id] = @xid;";
		...
		{
			Books_tags_link model = new Books_tags_link();
			if (row["id"]!=DBNull.Value) model.id = row["id"] as long?;
			if (row["book"]!=DBNull.Value) model.book = row["book"] as long?;
